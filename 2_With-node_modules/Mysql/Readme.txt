...
Tutorial
    ...
    2.2 Run createDB
      2.2.1 Mysql> node createDB.js
                Output
                    Connected!
                    Database created
                    Close the database connection.
    3.1 createTables
      3.1.1 createTables.js
                var mysql = require('mysql');
    ...
    3.2 Run createTables
      3.2.1 Mysql> node createTables.js
                Output
                    Executed now
                    Connected!
                    Table created
    ...
    4.2 Run createRecords
      4.2.1 Mysql> node createRecords.js
                Output
                    Executed now
                    Connected!
